...
label_taller = tk.Label(ventana, text="Taller")                              # Mostrar etiqueta taller
...
label_clases = tk.Label(ventana, text="Número de Clases")                    # Mostrar etiqueta número de clases
